...
class GroupADO implements EntityInterface {
    ...
    private static $colId = "id_group";
    private static $colDateGroupName = "name";
    private static $colMaxMembers = "max_members";
    private static $colFundationDate = "fundation_date";
    ...
    public function create($group) {
        ...
        $cons = "insert into " . GroupADO::$table . " (`id_user`,`name`,`max_members`,`fundation_date`) values (?, ?, ?, ?)";
