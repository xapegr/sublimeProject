...
/** UserADO.php
 * Entity UserADO
 * authors Javier Bueno and Xavier Pérez
 */
...
class UserADO implements EntityInterfaceADO {
     ...
     * @return object with the query results
     */
    public static function findFriendsById($user) {
        $cons = "select * from `" . UserADO::$table . "` inner join friends on users.id_user=friends.id_friend where friends.id_user = ?";
        $arrayValues = [$user->getId()];
